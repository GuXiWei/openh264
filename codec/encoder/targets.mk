...
ENCODER_ASM_MIPS64_SRCS=\
	$(ENCODER_SRCDIR)/core/mips64/dct_mmi.c\
	$(ENCODER_SRCDIR)/core/mips64/score_mmi.c\
	$(ENCODER_SRCDIR)/core/mips64/quant_mmi.c\

ENCODER_OBJSMIPS64 += $(ENCODER_ASM_MIPS64_SRCS:.c=.$(OBJ))
ifeq ($(ASM_ARCH), mips64)
ENCODER_OBJS += $(ENCODER_OBJSMIPS64)
endif
OBJS += $(ENCODER_OBJSMIPS64)
...
$(ENCODER_SRCDIR)/%.$(OBJ): $(ENCODER_SRCDIR)/%.c
	$(QUIET_CC)$(CC) $(CFLAGS) $(ASMFLAGS) $(INCLUDES) $(ENCODER_CFLAGS) $(ENCODER_INCLUDES) -c -o $@ $<
