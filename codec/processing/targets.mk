...
PROCESSING_ASM_MIPS64_SRCS=\
	$(PROCESSING_SRCDIR)/src/mips64/vaa_mmi.c\

PROCESSING_OBJSMIPS64 += $(PROCESSING_ASM_MIPS64_SRCS:.c=.$(OBJ))
ifeq ($(ASM_ARCH), mips64)
PROCESSING_OBJS += $(PROCESSING_OBJSMIPS64)
endif
OBJS += $(PROCESSING_OBJSMIPS64)
...
$(PROCESSING_SRCDIR)/%.$(OBJ): $(PROCESSING_SRCDIR)/%.c
	$(QUIET_CC)$(CC) $(CFLAGS) $(ASMFLAGS) $(INCLUDES) $(PROCESSING_CFLAGS) $(PROCESSING_INCLUDES) -c -o $@ $<
