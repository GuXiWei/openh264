...
DECODER_ASM_MIPS64_SRCS=\
	$(DECODER_SRCDIR)/core/mips64/dct_mmi.c\

DECODER_OBJSMIPS64 += $(DECODER_ASM_MIPS64_SRCS:.c=.$(OBJ))
ifeq ($(ASM_ARCH), mips64)
DECODER_OBJS += $(DECODER_OBJSMIPS64)
endif
OBJS += $(DECODER_OBJSMIPS64)
...
$(DECODER_SRCDIR)/%.$(OBJ): $(DECODER_SRCDIR)/%.c
	$(QUIET_CC)$(CC) $(CFLAGS) $(ASMFLAGS) $(INCLUDES) $(DECODER_CFLAGS) $(DECODER_INCLUDES) -c -o $@ $<
